...
下一步：阶段 4.5 第二刀前先列属性清单；目标是从“通用 FeedbackText 脉冲”升级到“具体目标反馈”，例如英雄按钮或随从 View 受击闪烁，但仍然只表现 Core 已完成的规则结果
...
下一步：阶段 4.5 第二刀，优先让具体目标出现基础受击或结算反馈，例如英雄按钮或随从 View 闪烁；开始前仍然先列属性清单
